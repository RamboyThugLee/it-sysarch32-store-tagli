...
const stripePromise = loadStripe('pk_test_51PF6IMIZ3mDt4x0n2lDCSQxYQKkuHVBMvm9ehS78BVPxCCL084G6bm4JOz6qZlWHXtfkXjw2sU2dggRiFuuwakey00ajmt9jA3'); // Replace with your publishable key
...
function ProductDetails() {
  ...
  const handleClick = async (productName, price) => {
    ...
    const response = await fetch('http://35.240.139.36/create-checkout-session', {
      method: 'POST',
      headers: {
